        ...
        mattPocockSkills =
          map
            (skillPath: {
              ...
              path = "${inputs.mattpocock-skills}/skills/${skillPath}";
            })
            [
