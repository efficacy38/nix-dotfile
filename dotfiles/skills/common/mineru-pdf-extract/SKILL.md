...
description: Use when extracting PDFs, scanned documents, images, Office files, URLs, or web pages with MinerU, especially when OCR, table recognition, formula recognition, Markdown, HTML, LaTeX, DOCX, or JSON output is needed.
---
